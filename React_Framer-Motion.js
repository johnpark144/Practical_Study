// ####### 리마인더 ########################################################################################################################################
// useTransform, useViewportScroll 에대해서 배우기
...
// Animate -- 에니메이션 효과, 
// Initial -- 시작점, 한번만 나오게
// Transition Options -- 옵션, transition, 바운스강도, stiffness, 바운스 효과, spring
// Hover -- whileHover, whileTap, 클릭하고 있는 동안, whileFocus, 포커스된 동안, whileDrag, 끌기 제스쳐가 발생하는 동안, whileInView 스크롤 할 때,  originX
// Varients -- mass, 무거워진, damping, 미끌려, delayChildren, 첫 자식, staggerChildren, 하나 나타나고 그다음, when, beforeChildren
// Keyfrane -- 키프레임, 배열로인한 작동 순서
// Repeating -- 애니메이션 반복, repeat, 반복 횟수, repeatType, 반복 방식
// AnimatePresence -- useState로 없애는 태그들, useLocation 으로 링크변경시에도 애니메이션 효과, mode="wait", onExitComplete
// Animating SVG -- 그림 그리기, pathLength
// useCycle -- 반복적인 두 로더,
// Dragging item -- 드래그 가능
// useScroll -- 스크롤에 따른 그림 그리기


// ######### React_Framer-Motion 관한 정보 링크 ##############################################################################################################
