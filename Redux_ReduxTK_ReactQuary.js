...
// Redux -- Provider, store.js, state를 가진 함수, dispatch를 가진 함수
// Redux Toolkit
// Redux Toolkit (with CreateSlice)
// Redux Toolkit-thunk -- useSelector, useDispatch
// ReactQuary -- useQuery, QueryClientProvider, isFetching keepPreviousData, onSuccess, onError, onSettled, enabled, 자동실행, 자동 retry, 주기적으로 refetch
// , 페이지네이션, useMutation, ReactQueryDevtools, axios, isFetching, 실시간

// ######### Redux_ReduxTK_ReactQuary 관한 정보 링크 #########################################################################################################
...
// ###### 시작 ############################################################################################################################################
// 상태 관리 해두면 좋은것들 : 로그인한 유저, innerWidth, innerHeight, Scroll, API에서 받아온 데이터
